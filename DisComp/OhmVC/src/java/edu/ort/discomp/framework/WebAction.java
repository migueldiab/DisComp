...
public abstract class WebAction
{
	 ...
	 */
	public abstract String execute(CommandFactory servlet, HttpServletRequest request, HttpServletResponse response) throws ServletException;
	 ...
	 * @throws ServletException
	 */
	public void forward(CommandFactory servlet, HttpServletRequest request, HttpServletResponse response, String page) throws ServletException
	{
		try {
